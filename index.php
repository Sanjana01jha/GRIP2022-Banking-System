...
<head>
 ...
 <link href="https://fonts.googleapis.com/css2?family=Tiro+Gurmukhi&display=swap" rel="stylesheet">
  ...
  <title>GRIP-Banking System by Sanjana Jha</title>
  <style>
    * {
...
<header>
  ...
  <div class="center head mt-0">
    <h2><b><span><img src="https://www.thesparksfoundationsingapore.org/images/logo_small.png" style="height:70px;width:60px" /></span>GRIP BANKING</b></h2>
  </div>
  <!---3 col start-->
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img src="./images/customner.png">
            </div>
            <br />
            <h5><b>Welcome to GRIP Bank !</b></h5>
            <br />
